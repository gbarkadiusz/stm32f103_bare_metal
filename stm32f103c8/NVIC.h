...
typedef union {
  ...
  struct {
    uint32_t SETENA : 32; // bit 0 SETENA
  } BITS;
} NVIC_ISER0_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t CLRENA : 32; // bit 0 CLRENA
  } BITS;
} NVIC_ICER0_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t SETPEND : 32; // bit 0 SETPEND
  } BITS;
} NVIC_ISPR0_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t CLRPEND : 32; // bit 0 CLRPEND
  } BITS;
} NVIC_ICPR0_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t ACTIVE : 32; // bit 0 ACTIVE
  } BITS;
} NVIC_IABR0_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t IPR_N0 : 8; // bit 0 IPR_N0
    uint32_t IPR_N1 : 8; // bit 8 IPR_N1
    uint32_t IPR_N2 : 8; // bit 16 IPR_N2
    uint32_t IPR_N3 : 8; // bit 24 IPR_N3
  } BITS;
} NVIC_IPR0_t;
