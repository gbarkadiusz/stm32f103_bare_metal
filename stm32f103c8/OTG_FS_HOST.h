...
typedef union {
  ...
  struct {
    uint32_t FSLSPCS : 2; // bit 0 FS/LS PHY clock select
    uint32_t FSLSS : 1; // bit 2 FS- and LS-only support
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t FRIVL : 16; // bit 0 Frame interval
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t FRNUM : 16; // bit 0 Frame number
    uint32_t FTREM : 16; // bit 16 Frame time remaining
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t PTXFSAVL : 16; // bit 0 Periodic transmit data FIFO space available
    uint32_t PTXQSAV : 8; // bit 16 Periodic transmit request queue space available
    uint32_t PTXQTOP : 8; // bit 24 Top of the periodic transmit request queue
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t HAINT : 16; // bit 0 Channel interrupts
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t HAINTM : 16; // bit 0 Channel interrupt mask
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t PCSTS : 1; // bit 0 Port connect status
    uint32_t PCDET : 1; // bit 1 Port connect detected
    uint32_t PENA : 1; // bit 2 Port enable
    uint32_t PENCHNG : 1; // bit 3 Port enable/disable change
    uint32_t POCA : 1; // bit 4 Port overcurrent active
    uint32_t POCCHNG : 1; // bit 5 Port overcurrent change
    uint32_t PRES : 1; // bit 6 Port resume
    uint32_t PSUSP : 1; // bit 7 Port suspend
    uint32_t PRST : 1; // bit 8 Port reset
    uint32_t RESERVED0 : 1; // bit 9
    uint32_t PLSTS : 2; // bit 10 Port line status
    uint32_t PPWR : 1; // bit 12 Port power
    uint32_t PTCTL : 4; // bit 13 Port test control
    uint32_t PSPD : 2; // bit 17 Port speed
    uint32_t RESERVED1 : 1; // bit 19
    uint32_t RESERVED2 : 1; // bit 20
    uint32_t RESERVED3 : 1; // bit 21
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t MPSIZ : 11; // bit 0 Maximum packet size
    uint32_t EPNUM : 4; // bit 11 Endpoint number
    uint32_t EPDIR : 1; // bit 15 Endpoint direction
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t LSDEV : 1; // bit 17 Low-speed device
    uint32_t EPTYP : 2; // bit 18 Endpoint type
    uint32_t MCNT : 2; // bit 20 Multicount
    uint32_t DAD : 7; // bit 22 Device address
    uint32_t ODDFRM : 1; // bit 29 Odd frame
    uint32_t CHDIS : 1; // bit 30 Channel disable
    uint32_t CHENA : 1; // bit 31 Channel enable
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t XFRC : 1; // bit 0 Transfer completed
    uint32_t CHH : 1; // bit 1 Channel halted
    uint32_t RESERVED0 : 1; // bit 2
    uint32_t STALL : 1; // bit 3 STALL response received interrupt
    uint32_t NAK : 1; // bit 4 NAK response received interrupt
    uint32_t ACK : 1; // bit 5 ACK response received/transmitted interrupt
    uint32_t RESERVED1 : 1; // bit 6
    uint32_t TXERR : 1; // bit 7 Transaction error
    uint32_t BBERR : 1; // bit 8 Babble error
    uint32_t FRMOR : 1; // bit 9 Frame overrun
    uint32_t DTERR : 1; // bit 10 Data toggle error
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t XFRCM : 1; // bit 0 Transfer completed mask
    uint32_t CHHM : 1; // bit 1 Channel halted mask
    uint32_t RESERVED0 : 1; // bit 2
    uint32_t STALLM : 1; // bit 3 STALL response received interrupt mask
    uint32_t NAKM : 1; // bit 4 NAK response received interrupt mask
    uint32_t ACKM : 1; // bit 5 ACK response received/transmitted interrupt mask
    uint32_t NYET : 1; // bit 6 response received interrupt mask
    uint32_t TXERRM : 1; // bit 7 Transaction error mask
    uint32_t BBERRM : 1; // bit 8 Babble error mask
    uint32_t FRMORM : 1; // bit 9 Frame overrun mask
    uint32_t DTERRM : 1; // bit 10 Data toggle error mask
...
typedef union {
  ...
  struct {
    ...
    uint32_t DPID : 2; // bit 29 Data PID
