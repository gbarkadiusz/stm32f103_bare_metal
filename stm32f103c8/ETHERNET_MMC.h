...
typedef union {
  ...
  struct {
    uint32_t CR : 1; // bit 0 Counter reset
    uint32_t CSR : 1; // bit 1 Counter stop rollover
    uint32_t ROR : 1; // bit 2 Reset on read
    ...
    uint32_t MCF : 1; // bit 31 MMC counter freeze
  } BITS;
...
typedef union {
  ...
  struct {
    ...
    uint32_t RFCES : 1; // bit 5 Received frames CRC error status
    uint32_t RFAES : 1; // bit 6 Received frames alignment error status
    ...
    uint32_t RGUFS : 1; // bit 17 Received Good Unicast Frames Status
    uint32_t RESERVED15 : 1; // bit 18
    uint32_t RESERVED16 : 1; // bit 19
    uint32_t RESERVED17 : 1; // bit 20
    uint32_t RESERVED18 : 1; // bit 21
...
typedef union {
  ...
  struct {
    ...
    uint32_t TGFSCS : 1; // bit 14 Transmitted good frames single collision status
    uint32_t TGFMSCS : 1; // bit 15 Transmitted good frames more single collision status
    uint32_t RESERVED14 : 1; // bit 16
    uint32_t RESERVED15 : 1; // bit 17
    uint32_t RESERVED16 : 1; // bit 18
    uint32_t RESERVED17 : 1; // bit 19
    uint32_t RESERVED18 : 1; // bit 20
    uint32_t TGFS : 1; // bit 21 Transmitted good frames status
    uint32_t RESERVED19 : 1; // bit 22
    uint32_t RESERVED20 : 1; // bit 23
    uint32_t RESERVED21 : 1; // bit 24
    uint32_t RESERVED22 : 1; // bit 25
...
typedef union {
  ...
  struct {
    ...
    uint32_t RESERVED3 : 1; // bit 3
    uint32_t RESERVED4 : 1; // bit 4
    uint32_t RFCEM : 1; // bit 5 Received frame CRC error mask
    uint32_t RFAEM : 1; // bit 6 Received frames alignment error mask
    uint32_t RESERVED5 : 1; // bit 7
    uint32_t RESERVED6 : 1; // bit 8
    uint32_t RESERVED7 : 1; // bit 9
    uint32_t RESERVED8 : 1; // bit 10
    ...
    uint32_t RESERVED13 : 1; // bit 15
    uint32_t RESERVED14 : 1; // bit 16
    uint32_t RGUFM : 1; // bit 17 Received good unicast frames mask
    uint32_t RESERVED15 : 1; // bit 18
    uint32_t RESERVED16 : 1; // bit 19
    uint32_t RESERVED17 : 1; // bit 20
    uint32_t RESERVED18 : 1; // bit 21
...
typedef union {
  ...
  struct {
    ...
    uint32_t RESERVED12 : 1; // bit 12
    uint32_t RESERVED13 : 1; // bit 13
    uint32_t TGFSCM : 1; // bit 14 Transmitted good frames single collision mask
    uint32_t TGFMSCM : 1; // bit 15 Transmitted good frames more single collision mask
    uint32_t RESERVED14 : 1; // bit 16
    uint32_t RESERVED15 : 1; // bit 17
    uint32_t RESERVED16 : 1; // bit 18
    uint32_t RESERVED17 : 1; // bit 19
    uint32_t RESERVED18 : 1; // bit 20
    uint32_t TGFM : 1; // bit 21 Transmitted good frames mask
    uint32_t RESERVED19 : 1; // bit 22
    uint32_t RESERVED20 : 1; // bit 23
    uint32_t RESERVED21 : 1; // bit 24
    uint32_t RESERVED22 : 1; // bit 25
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t TGFSCC : 32; // bit 0 Transmitted good frames after a single collision counter
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t TGFMSCC : 32; // bit 0 Transmitted good frames after more than a single collision counter
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t TGFC : 32; // bit 0 Transmitted good frames counter
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t RFCFC : 32; // bit 0 Received frames with CRC error counter
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t RFAEC : 32; // bit 0 Received frames with alignment error counter
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t RGUFC : 32; // bit 0 Received good unicast frames counter
  } BITS;
