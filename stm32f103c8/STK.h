...
typedef union {
  ...
  struct {
    ...
    uint32_t COUNTFLAG : 1; // bit 16 COUNTFLAG
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t RELOAD : 24; // bit 0 RELOAD value
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t CURRENT : 24; // bit 0 Current counter value
    uint32_t RESERVED0 : 1; // bit 24
    uint32_t RESERVED1 : 1; // bit 25
    uint32_t RESERVED2 : 1; // bit 26
    uint32_t RESERVED3 : 1; // bit 27
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t TENMS : 24; // bit 0 Calibration value
    uint32_t RESERVED0 : 1; // bit 24
    uint32_t RESERVED1 : 1; // bit 25
    uint32_t RESERVED2 : 1; // bit 26
    uint32_t RESERVED3 : 1; // bit 27
