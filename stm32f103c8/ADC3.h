 ...
 * for the ADC3 peripheral of the STM32F103.
 */
...
#define ADC3 ((ADC3_t *)ADC3_BASE)

#define ADC3_SRbits (ADC3->SR.BITS)
#define ADC3_CR1bits (ADC3->CR1.BITS)
#define ADC3_CR2bits (ADC3->CR2.BITS)
#define ADC3_SMPR1bits (ADC3->SMPR1.BITS)
#define ADC3_SMPR2bits (ADC3->SMPR2.BITS)
#define ADC3_JOFR1bits (ADC3->JOFR1.BITS)
#define ADC3_JOFR2bits (ADC3->JOFR2.BITS)
#define ADC3_JOFR3bits (ADC3->JOFR3.BITS)
#define ADC3_JOFR4bits (ADC3->JOFR4.BITS)
#define ADC3_HTRbits (ADC3->HTR.BITS)
#define ADC3_LTRbits (ADC3->LTR.BITS)
#define ADC3_SQR1bits (ADC3->SQR1.BITS)
#define ADC3_SQR2bits (ADC3->SQR2.BITS)
#define ADC3_SQR3bits (ADC3->SQR3.BITS)
#define ADC3_JSQRbits (ADC3->JSQR.BITS)
#define ADC3_JDR1bits (ADC3->JDR1.BITS)
#define ADC3_JDR2bits (ADC3->JDR2.BITS)
#define ADC3_JDR3bits (ADC3->JDR3.BITS)
#define ADC3_JDR4bits (ADC3->JDR4.BITS)
#define ADC3_DRbits (ADC3->DR.BITS)
