...
typedef union {
  ...
  struct {
    uint32_t SECIE : 1; // bit 0 Second interrupt Enable
    uint32_t ALRIE : 1; // bit 1 Alarm interrupt Enable
    uint32_t OWIE : 1; // bit 2 Overflow interrupt Enable
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t SECF : 1; // bit 0 Second Flag
    uint32_t ALRF : 1; // bit 1 Alarm Flag
    uint32_t OWF : 1; // bit 2 Overflow Flag
    uint32_t RSF : 1; // bit 3 Registers Synchronized Flag
    uint32_t CNF : 1; // bit 4 Configuration Flag
    uint32_t RTOFF : 1; // bit 5 RTC operation OFF
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t PRLH : 4; // bit 0 RTC Prescaler Load Register High
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t PRLL : 16; // bit 0 RTC Prescaler Divider Register Low
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t DIVH : 4; // bit 0 RTC prescaler divider register high
    uint32_t RESERVED0 : 1; // bit 4
    uint32_t RESERVED1 : 1; // bit 5
    uint32_t RESERVED2 : 1; // bit 6
    uint32_t RESERVED3 : 1; // bit 7
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t DIVL : 16; // bit 0 RTC prescaler divider register Low
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t CNTH : 16; // bit 0 RTC counter register high
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t CNTL : 16; // bit 0 RTC counter register Low
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t ALRH : 16; // bit 0 RTC alarm register high
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t ALRL : 16; // bit 0 RTC alarm register low
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
