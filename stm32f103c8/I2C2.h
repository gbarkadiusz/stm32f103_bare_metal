 ...
 * for the I2C2 peripheral of the STM32F103.
 */
...
#define I2C2 ((I2C2_t *)I2C2_BASE)

#define I2C2_CR1bits (I2C2->CR1.BITS)
#define I2C2_CR2bits (I2C2->CR2.BITS)
#define I2C2_OAR1bits (I2C2->OAR1.BITS)
#define I2C2_OAR2bits (I2C2->OAR2.BITS)
#define I2C2_DRbits (I2C2->DR.BITS)
#define I2C2_SR1bits (I2C2->SR1.BITS)
#define I2C2_SR2bits (I2C2->SR2.BITS)
#define I2C2_CCRbits (I2C2->CCR.BITS)
#define I2C2_TRISEbits (I2C2->TRISE.BITS)
