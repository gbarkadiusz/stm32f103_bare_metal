...
typedef union {
  ...
  struct {
    uint32_t PIN : 4; // bit 0 Pin selection
    uint32_t PORT : 3; // bit 4 Port selection
    uint32_t EVOE : 1; // bit 7 Event Output Enable
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t SPI1_REMAP : 1; // bit 0 SPI1 remapping
    uint32_t I2C1_REMAP : 1; // bit 1 I2C1 remapping
    uint32_t USART1_REMAP : 1; // bit 2 USART1 remapping
    uint32_t USART2_REMAP : 1; // bit 3 USART2 remapping
    uint32_t USART3_REMAP : 2; // bit 4 USART3 remapping
    uint32_t TIM1_REMAP : 2; // bit 6 TIM1 remapping
    uint32_t TIM2_REMAP : 2; // bit 8 TIM2 remapping
    uint32_t TIM3_REMAP : 2; // bit 10 TIM3 remapping
    uint32_t TIM4_REMAP : 1; // bit 12 TIM4 remapping
    uint32_t CAN_REMAP : 2; // bit 13 CAN1 remapping
    uint32_t PD01_REMAP : 1; // bit 15 Port D0/Port D1 mapping on OSCIN/OSCOUT
    uint32_t TIM5CH4_IREMAP : 1; // bit 16 Set and cleared by software
    uint32_t ADC1_ETRGINJ_REMAP : 1; // bit 17 ADC 1 External trigger injected conversion remapping
    uint32_t ADC1_ETRGREG_REMAP : 1; // bit 18 ADC 1 external trigger regular conversion remapping
    uint32_t ADC2_ETRGINJ_REMAP : 1; // bit 19 ADC 2 external trigger injected conversion remapping
    uint32_t ADC2_ETRGREG_REMAP : 1; // bit 20 ADC 2 external trigger regular conversion remapping
    uint32_t RESERVED0 : 1; // bit 21
    uint32_t RESERVED1 : 1; // bit 22
    uint32_t RESERVED2 : 1; // bit 23
    uint32_t SWJ_CFG : 3; // bit 24 Serial wire JTAG configuration
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t EXTI0 : 4; // bit 0 EXTI0 configuration
    uint32_t EXTI1 : 4; // bit 4 EXTI1 configuration
    uint32_t EXTI2 : 4; // bit 8 EXTI2 configuration
    uint32_t EXTI3 : 4; // bit 12 EXTI3 configuration
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t EXTI4 : 4; // bit 0 EXTI4 configuration
    uint32_t EXTI5 : 4; // bit 4 EXTI5 configuration
    uint32_t EXTI6 : 4; // bit 8 EXTI6 configuration
    uint32_t EXTI7 : 4; // bit 12 EXTI7 configuration
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t EXTI8 : 4; // bit 0 EXTI8 configuration
    uint32_t EXTI9 : 4; // bit 4 EXTI9 configuration
    uint32_t EXTI10 : 4; // bit 8 EXTI10 configuration
    uint32_t EXTI11 : 4; // bit 12 EXTI11 configuration
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  volatile uint32_t REG;
  struct {
    uint32_t EXTI12 : 4; // bit 0 EXTI12 configuration
    uint32_t EXTI13 : 4; // bit 4 EXTI13 configuration
    uint32_t EXTI14 : 4; // bit 8 EXTI14 configuration
    uint32_t EXTI15 : 4; // bit 12 EXTI15 configuration
    uint32_t RESERVED0 : 1; // bit 16
    uint32_t RESERVED1 : 1; // bit 17
    uint32_t RESERVED2 : 1; // bit 18
    uint32_t RESERVED3 : 1; // bit 19
...
typedef union {
  ...
  struct {
    ...
    uint32_t TIM9_REMAP : 1; // bit 5 TIM9 remapping
    uint32_t TIM10_REMAP : 1; // bit 6 TIM10 remapping
    uint32_t TIM11_REMAP : 1; // bit 7 TIM11 remapping
    uint32_t TIM13_REMAP : 1; // bit 8 TIM13 remapping
    uint32_t TIM14_REMAP : 1; // bit 9 TIM14 remapping
    uint32_t FSMC_NADV : 1; // bit 10 NADV connect/disconnect
