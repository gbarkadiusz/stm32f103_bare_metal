...
typedef union {
  ...
  struct {
    volatile uint32_t PWRCTRL : 2; // bit 0 PWRCTRL
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CLKDIV : 8; // bit 0 Clock divide factor
    ...
    volatile uint32_t WIDBUS : 2; // bit 11 Wide bus mode enable bit
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CMDARG : 32; // bit 0 Command argument
  } BITS;
} SDIO_ARG_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CMDINDEX : 6; // bit 0 CMDINDEX
    volatile uint32_t WAITRESP : 2; // bit 6 WAITRESP
    volatile uint32_t WAITINT : 1; // bit 8 WAITINT
    volatile uint32_t WAITPEND : 1; // bit 9 WAITPEND
    volatile uint32_t CPSMEN : 1; // bit 10 CPSMEN
    volatile uint32_t SDIOSuspend : 1; // bit 11 SDIOSuspend
    volatile uint32_t ENCMDcompl : 1; // bit 12 ENCMDcompl
    volatile uint32_t nIEN : 1; // bit 13 nIEN
    volatile uint32_t CE_ATACMD : 1; // bit 14 CE_ATACMD
    volatile uint32_t RESERVED0 : 1; // bit 15
    volatile uint32_t RESERVED1 : 1; // bit 16
    volatile uint32_t RESERVED2 : 1; // bit 17
    volatile uint32_t RESERVED3 : 1; // bit 18
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t RESPCMD : 6; // bit 0 RESPCMD
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CARDSTATUS1 : 32; // bit 0 CARDSTATUS1
  } BITS;
} SDIO_RESPI1_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CARDSTATUS2 : 32; // bit 0 CARDSTATUS2
  } BITS;
} SDIO_RESP2_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CARDSTATUS3 : 32; // bit 0 CARDSTATUS3
  } BITS;
} SDIO_RESP3_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CARDSTATUS4 : 32; // bit 0 CARDSTATUS4
  } BITS;
} SDIO_RESP4_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t DATATIME : 32; // bit 0 Data timeout period
  } BITS;
} SDIO_DTIMER_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t DATALENGTH : 25; // bit 0 Data length value
    volatile uint32_t RESERVED0 : 1; // bit 25
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t DTEN : 1; // bit 0 DTEN
    volatile uint32_t DTDIR : 1; // bit 1 DTDIR
    volatile uint32_t DTMODE : 1; // bit 2 DTMODE
    volatile uint32_t DMAEN : 1; // bit 3 DMAEN
    volatile uint32_t DBLOCKSIZE : 4; // bit 4 DBLOCKSIZE
    volatile uint32_t PWSTART : 1; // bit 8 PWSTART
    volatile uint32_t PWSTOP : 1; // bit 9 PWSTOP
    volatile uint32_t RWMOD : 1; // bit 10 RWMOD
    volatile uint32_t SDIOEN : 1; // bit 11 SDIOEN
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t DATACOUNT : 25; // bit 0 Data count value
    volatile uint32_t RESERVED0 : 1; // bit 25
    volatile uint32_t RESERVED1 : 1; // bit 26
    volatile uint32_t RESERVED2 : 1; // bit 27
    volatile uint32_t RESERVED3 : 1; // bit 28
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CCRCFAIL : 1; // bit 0 CCRCFAIL
    volatile uint32_t DCRCFAIL : 1; // bit 1 DCRCFAIL
    volatile uint32_t CTIMEOUT : 1; // bit 2 CTIMEOUT
    volatile uint32_t DTIMEOUT : 1; // bit 3 DTIMEOUT
    volatile uint32_t TXUNDERR : 1; // bit 4 TXUNDERR
    volatile uint32_t RXOVERR : 1; // bit 5 RXOVERR
    volatile uint32_t CMDREND : 1; // bit 6 CMDREND
    volatile uint32_t CMDSENT : 1; // bit 7 CMDSENT
    volatile uint32_t DATAEND : 1; // bit 8 DATAEND
    volatile uint32_t STBITERR : 1; // bit 9 STBITERR
    volatile uint32_t DBCKEND : 1; // bit 10 DBCKEND
    volatile uint32_t CMDACT : 1; // bit 11 CMDACT
    volatile uint32_t TXACT : 1; // bit 12 TXACT
    volatile uint32_t RXACT : 1; // bit 13 RXACT
    volatile uint32_t TXFIFOHE : 1; // bit 14 TXFIFOHE
    volatile uint32_t RXFIFOHF : 1; // bit 15 RXFIFOHF
    volatile uint32_t TXFIFOF : 1; // bit 16 TXFIFOF
    volatile uint32_t RXFIFOF : 1; // bit 17 RXFIFOF
    volatile uint32_t TXFIFOE : 1; // bit 18 TXFIFOE
    volatile uint32_t RXFIFOE : 1; // bit 19 RXFIFOE
    volatile uint32_t TXDAVL : 1; // bit 20 TXDAVL
    volatile uint32_t RXDAVL : 1; // bit 21 RXDAVL
    volatile uint32_t SDIOIT : 1; // bit 22 SDIOIT
    volatile uint32_t CEATAEND : 1; // bit 23 CEATAEND
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CCRCFAILC : 1; // bit 0 CCRCFAILC
    volatile uint32_t DCRCFAILC : 1; // bit 1 DCRCFAILC
    volatile uint32_t CTIMEOUTC : 1; // bit 2 CTIMEOUTC
    volatile uint32_t DTIMEOUTC : 1; // bit 3 DTIMEOUTC
    volatile uint32_t TXUNDERRC : 1; // bit 4 TXUNDERRC
    volatile uint32_t RXOVERRC : 1; // bit 5 RXOVERRC
    volatile uint32_t CMDRENDC : 1; // bit 6 CMDRENDC
    volatile uint32_t CMDSENTC : 1; // bit 7 CMDSENTC
    volatile uint32_t DATAENDC : 1; // bit 8 DATAENDC
    volatile uint32_t STBITERRC : 1; // bit 9 STBITERRC
    volatile uint32_t DBCKENDC : 1; // bit 10 DBCKENDC
    ...
    volatile uint32_t SDIOITC : 1; // bit 22 SDIOITC
    volatile uint32_t CEATAENDC : 1; // bit 23 CEATAENDC
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CCRCFAILIE : 1; // bit 0 CCRCFAILIE
    volatile uint32_t DCRCFAILIE : 1; // bit 1 DCRCFAILIE
    volatile uint32_t CTIMEOUTIE : 1; // bit 2 CTIMEOUTIE
    volatile uint32_t DTIMEOUTIE : 1; // bit 3 DTIMEOUTIE
    volatile uint32_t TXUNDERRIE : 1; // bit 4 TXUNDERRIE
    volatile uint32_t RXOVERRIE : 1; // bit 5 RXOVERRIE
    volatile uint32_t CMDRENDIE : 1; // bit 6 CMDRENDIE
    volatile uint32_t CMDSENTIE : 1; // bit 7 CMDSENTIE
    volatile uint32_t DATAENDIE : 1; // bit 8 DATAENDIE
    volatile uint32_t STBITERRIE : 1; // bit 9 STBITERRIE
    volatile uint32_t DBACKENDIE : 1; // bit 10 DBACKENDIE
    volatile uint32_t CMDACTIE : 1; // bit 11 CMDACTIE
    volatile uint32_t TXACTIE : 1; // bit 12 TXACTIE
    volatile uint32_t RXACTIE : 1; // bit 13 RXACTIE
    volatile uint32_t TXFIFOHEIE : 1; // bit 14 TXFIFOHEIE
    volatile uint32_t RXFIFOHFIE : 1; // bit 15 RXFIFOHFIE
    volatile uint32_t TXFIFOFIE : 1; // bit 16 TXFIFOFIE
    volatile uint32_t RXFIFOFIE : 1; // bit 17 RXFIFOFIE
    volatile uint32_t TXFIFOEIE : 1; // bit 18 TXFIFOEIE
    volatile uint32_t RXFIFOEIE : 1; // bit 19 RXFIFOEIE
    volatile uint32_t TXDAVLIE : 1; // bit 20 TXDAVLIE
    volatile uint32_t RXDAVLIE : 1; // bit 21 RXDAVLIE
    volatile uint32_t SDIOITIE : 1; // bit 22 SDIOITIE
    volatile uint32_t CEATENDIE : 1; // bit 23 CEATENDIE
    volatile uint32_t RESERVED0 : 1; // bit 24
    volatile uint32_t RESERVED1 : 1; // bit 25
    volatile uint32_t RESERVED2 : 1; // bit 26
    volatile uint32_t RESERVED3 : 1; // bit 27
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t FIF0COUNT : 24; // bit 0 FIF0COUNT
    volatile uint32_t RESERVED0 : 1; // bit 24
    volatile uint32_t RESERVED1 : 1; // bit 25
    volatile uint32_t RESERVED2 : 1; // bit 26
    volatile uint32_t RESERVED3 : 1; // bit 27
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t FIFOData : 32; // bit 0 FIFOData
  } BITS;
} SDIO_FIFO_t;
