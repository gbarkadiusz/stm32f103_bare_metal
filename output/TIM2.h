 ...
 * for the TIM2 peripheral of the STM32F103.
 */
...
#define TIM2 ((TIM2_t *)TIM2_BASE)

#define TIM2_CR1bits (TIM2->CR1.BITS)
#define TIM2_CR2bits (TIM2->CR2.BITS)
#define TIM2_SMCRbits (TIM2->SMCR.BITS)
#define TIM2_DIERbits (TIM2->DIER.BITS)
#define TIM2_SRbits (TIM2->SR.BITS)
#define TIM2_EGRbits (TIM2->EGR.BITS)
#define TIM2_CCMR1_Outputbits (TIM2->CCMR1_Output.BITS)
#define TIM2_CCMR1_Inputbits (TIM2->CCMR1_Input.BITS)
#define TIM2_CCMR2_Outputbits (TIM2->CCMR2_Output.BITS)
#define TIM2_CCMR2_Inputbits (TIM2->CCMR2_Input.BITS)
#define TIM2_CCERbits (TIM2->CCER.BITS)
#define TIM2_CNTbits (TIM2->CNT.BITS)
#define TIM2_PSCbits (TIM2->PSC.BITS)
#define TIM2_ARRbits (TIM2->ARR.BITS)
#define TIM2_CCR1bits (TIM2->CCR1.BITS)
#define TIM2_CCR2bits (TIM2->CCR2.BITS)
#define TIM2_CCR3bits (TIM2->CCR3.BITS)
#define TIM2_CCR4bits (TIM2->CCR4.BITS)
#define TIM2_DCRbits (TIM2->DCR.BITS)
#define TIM2_DMARbits (TIM2->DMAR.BITS)
