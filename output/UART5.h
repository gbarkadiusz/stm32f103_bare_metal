...
typedef union {
  ...
  struct {
    volatile uint32_t PE : 1; // bit 0 PE
    volatile uint32_t FE : 1; // bit 1 FE
    volatile uint32_t NE : 1; // bit 2 NE
    volatile uint32_t ORE : 1; // bit 3 ORE
    volatile uint32_t IDLE : 1; // bit 4 IDLE
    volatile uint32_t RXNE : 1; // bit 5 RXNE
    volatile uint32_t TC : 1; // bit 6 TC
    volatile uint32_t TXE : 1; // bit 7 TXE
    volatile uint32_t LBD : 1; // bit 8 LBD
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t SBK : 1; // bit 0 SBK
    volatile uint32_t RWU : 1; // bit 1 RWU
    volatile uint32_t RE : 1; // bit 2 RE
    volatile uint32_t TE : 1; // bit 3 TE
    volatile uint32_t IDLEIE : 1; // bit 4 IDLEIE
    volatile uint32_t RXNEIE : 1; // bit 5 RXNEIE
    volatile uint32_t TCIE : 1; // bit 6 TCIE
    volatile uint32_t TXEIE : 1; // bit 7 TXEIE
    volatile uint32_t PEIE : 1; // bit 8 PEIE
    volatile uint32_t PS : 1; // bit 9 PS
    volatile uint32_t PCE : 1; // bit 10 PCE
    volatile uint32_t WAKE : 1; // bit 11 WAKE
    volatile uint32_t M : 1; // bit 12 M
    volatile uint32_t UE : 1; // bit 13 UE
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t ADD : 4; // bit 0 ADD
    volatile uint32_t RESERVED0 : 1; // bit 4
    volatile uint32_t LBDL : 1; // bit 5 LBDL
    volatile uint32_t LBDIE : 1; // bit 6 LBDIE
    ...
    volatile uint32_t STOP : 2; // bit 12 STOP
    volatile uint32_t LINEN : 1; // bit 14 LINEN
    volatile uint32_t RESERVED6 : 1; // bit 15
    volatile uint32_t RESERVED7 : 1; // bit 16
    volatile uint32_t RESERVED8 : 1; // bit 17
    volatile uint32_t RESERVED9 : 1; // bit 18
