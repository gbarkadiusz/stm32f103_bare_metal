...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t HSITRIM : 5; // bit 3 Internal High Speed clock trimming
    volatile uint32_t HSICAL : 8; // bit 8 Internal High Speed clock Calibration
    ...
    volatile uint32_t PLLRDY : 1; // bit 25 PLL clock ready flag
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t SW : 2; // bit 0 System clock Switch
    volatile uint32_t SWS : 2; // bit 2 System Clock Switch Status
    volatile uint32_t HPRE : 4; // bit 4 AHB prescaler
    volatile uint32_t PPRE1 : 3; // bit 8 APB Low speed prescaler (APB1)
    volatile uint32_t PPRE2 : 3; // bit 11 APB High speed prescaler (APB2)
    volatile uint32_t ADCPRE : 2; // bit 14 ADC prescaler
    volatile uint32_t PLLSRC : 1; // bit 16 PLL entry clock source
    volatile uint32_t PLLXTPRE : 1; // bit 17 HSE divider for PLL entry
    volatile uint32_t PLLMUL : 4; // bit 18 PLL Multiplication Factor
    volatile uint32_t OTGFSPRE : 1; // bit 22 USB OTG FS prescaler
    volatile uint32_t RESERVED0 : 1; // bit 23
    volatile uint32_t MCO : 3; // bit 24 Microcontroller clock output
    volatile uint32_t RESERVED1 : 1; // bit 27
    volatile uint32_t RESERVED2 : 1; // bit 28
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t PLLRDYF : 1; // bit 4 PLL Ready Interrupt flag
    ...
    volatile uint32_t PLLRDYC : 1; // bit 20 PLL Ready Interrupt Clear
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t AFIORST : 1; // bit 0 Alternate function I/O reset
    volatile uint32_t RESERVED0 : 1; // bit 1
    volatile uint32_t IOPARST : 1; // bit 2 IO port A reset
    volatile uint32_t IOPBRST : 1; // bit 3 IO port B reset
    volatile uint32_t IOPCRST : 1; // bit 4 IO port C reset
    volatile uint32_t IOPDRST : 1; // bit 5 IO port D reset
    volatile uint32_t IOPERST : 1; // bit 6 IO port E reset
    volatile uint32_t IOPFRST : 1; // bit 7 IO port F reset
    volatile uint32_t IOPGRST : 1; // bit 8 IO port G reset
    volatile uint32_t ADC1RST : 1; // bit 9 ADC 1 interface reset
    volatile uint32_t ADC2RST : 1; // bit 10 ADC 2 interface reset
    volatile uint32_t TIM1RST : 1; // bit 11 TIM1 timer reset
    volatile uint32_t SPI1RST : 1; // bit 12 SPI 1 reset
    volatile uint32_t TIM8RST : 1; // bit 13 TIM8 timer reset
    volatile uint32_t USART1RST : 1; // bit 14 USART1 reset
    volatile uint32_t ADC3RST : 1; // bit 15 ADC 3 interface reset
    volatile uint32_t RESERVED1 : 1; // bit 16
    volatile uint32_t RESERVED2 : 1; // bit 17
    volatile uint32_t RESERVED3 : 1; // bit 18
    volatile uint32_t TIM9RST : 1; // bit 19 TIM9 timer reset
    volatile uint32_t TIM10RST : 1; // bit 20 TIM10 timer reset
    volatile uint32_t TIM11RST : 1; // bit 21 TIM11 timer reset
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t USART2RST : 1; // bit 17 USART 2 reset
    volatile uint32_t USART3RST : 1; // bit 18 USART 3 reset
    volatile uint32_t UART4RST : 1; // bit 19 UART 4 reset
    volatile uint32_t UART5RST : 1; // bit 20 UART 5 reset
    volatile uint32_t I2C1RST : 1; // bit 21 I2C1 reset
    volatile uint32_t I2C2RST : 1; // bit 22 I2C2 reset
    volatile uint32_t USBRST : 1; // bit 23 USB reset
    volatile uint32_t RESERVED5 : 1; // bit 24
    volatile uint32_t CANRST : 1; // bit 25 CAN reset
    volatile uint32_t RESERVED6 : 1; // bit 26
    volatile uint32_t BKPRST : 1; // bit 27 Backup interface reset
    volatile uint32_t PWRRST : 1; // bit 28 Power interface reset
    volatile uint32_t DACRST : 1; // bit 29 DAC interface reset
    volatile uint32_t RESERVED7 : 1; // bit 30
    volatile uint32_t RESERVED8 : 1; // bit 31
  } BITS;
} RCC_APB1RSTR_t;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t DMA1EN : 1; // bit 0 DMA1 clock enable
    volatile uint32_t DMA2EN : 1; // bit 1 DMA2 clock enable
    volatile uint32_t SRAMEN : 1; // bit 2 SRAM interface clock enable
    volatile uint32_t RESERVED0 : 1; // bit 3
    volatile uint32_t FLITFEN : 1; // bit 4 FLITF clock enable
    volatile uint32_t RESERVED1 : 1; // bit 5
    volatile uint32_t CRCEN : 1; // bit 6 CRC clock enable
    volatile uint32_t RESERVED2 : 1; // bit 7
    volatile uint32_t FSMCEN : 1; // bit 8 FSMC clock enable
    volatile uint32_t RESERVED3 : 1; // bit 9
    volatile uint32_t SDIOEN : 1; // bit 10 SDIO clock enable
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t AFIOEN : 1; // bit 0 Alternate function I/O clock enable
    volatile uint32_t RESERVED0 : 1; // bit 1
    volatile uint32_t IOPAEN : 1; // bit 2 I/O port A clock enable
    volatile uint32_t IOPBEN : 1; // bit 3 I/O port B clock enable
    volatile uint32_t IOPCEN : 1; // bit 4 I/O port C clock enable
    volatile uint32_t IOPDEN : 1; // bit 5 I/O port D clock enable
    volatile uint32_t IOPEEN : 1; // bit 6 I/O port E clock enable
    volatile uint32_t IOPFEN : 1; // bit 7 I/O port F clock enable
    volatile uint32_t IOPGEN : 1; // bit 8 I/O port G clock enable
    volatile uint32_t ADC1EN : 1; // bit 9 ADC 1 interface clock enable
    volatile uint32_t ADC2EN : 1; // bit 10 ADC 2 interface clock enable
    volatile uint32_t TIM1EN : 1; // bit 11 TIM1 Timer clock enable
    volatile uint32_t SPI1EN : 1; // bit 12 SPI 1 clock enable
    volatile uint32_t TIM8EN : 1; // bit 13 TIM8 Timer clock enable
    volatile uint32_t USART1EN : 1; // bit 14 USART1 clock enable
    volatile uint32_t ADC3EN : 1; // bit 15 ADC3 interface clock enable
    volatile uint32_t RESERVED1 : 1; // bit 16
    volatile uint32_t RESERVED2 : 1; // bit 17
    volatile uint32_t RESERVED3 : 1; // bit 18
    volatile uint32_t TIM9EN : 1; // bit 19 TIM9 Timer clock enable
    volatile uint32_t TIM10EN : 1; // bit 20 TIM10 Timer clock enable
    volatile uint32_t TIM11EN : 1; // bit 21 TIM11 Timer clock enable
    volatile uint32_t RESERVED4 : 1; // bit 22
    volatile uint32_t RESERVED5 : 1; // bit 23
    volatile uint32_t RESERVED6 : 1; // bit 24
    volatile uint32_t RESERVED7 : 1; // bit 25
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t RESERVED2 : 1; // bit 12
    volatile uint32_t RESERVED3 : 1; // bit 13
    volatile uint32_t SPI2EN : 1; // bit 14 SPI 2 clock enable
    volatile uint32_t SPI3EN : 1; // bit 15 SPI 3 clock enable
    volatile uint32_t RESERVED4 : 1; // bit 16
    volatile uint32_t USART2EN : 1; // bit 17 USART 2 clock enable
    volatile uint32_t USART3EN : 1; // bit 18 USART 3 clock enable
    volatile uint32_t UART4EN : 1; // bit 19 UART 4 clock enable
    volatile uint32_t UART5EN : 1; // bit 20 UART 5 clock enable
    volatile uint32_t I2C1EN : 1; // bit 21 I2C 1 clock enable
    volatile uint32_t I2C2EN : 1; // bit 22 I2C 2 clock enable
    volatile uint32_t USBEN : 1; // bit 23 USB clock enable
    volatile uint32_t RESERVED5 : 1; // bit 24
    volatile uint32_t CANEN : 1; // bit 25 CAN clock enable
    volatile uint32_t RESERVED6 : 1; // bit 26
    volatile uint32_t BKPEN : 1; // bit 27 Backup interface clock enable
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t RTCSEL : 2; // bit 8 RTC clock source selection
