...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t HNSSCHG : 1; // bit 9 Host negotiation success status change
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t TOCAL : 3; // bit 0 FS timeout calibration
    ...
    volatile uint32_t TRDT : 4; // bit 10 USB turnaround time
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t CSRST : 1; // bit 0 Core soft reset
    ...
    volatile uint32_t TXFNUM : 5; // bit 6 TxFIFO number
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t GOUTNAKEFF : 1; // bit 7 Global OUT NAK effective
    ...
    volatile uint32_t IPXFR_INCOMPISOOUT : 1; // bit 21 Incomplete periodic transfer(Host mode)/Incomplete isochronous OUT transfer(Device mode)
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t EPMISM : 1; // bit 17 Endpoint mismatch interrupt mask
    ...
    volatile uint32_t IPXFRM_IISOOXFRM : 1; // bit 21 Incomplete periodic transfer mask(Host mode)/Incomplete isochronous OUT transfer mask(Device mode)
    volatile uint32_t RESERVED4 : 1; // bit 22
    volatile uint32_t RESERVED5 : 1; // bit 23
    volatile uint32_t PRTIM : 1; // bit 24 Host port interrupt mask
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t EPNUM : 4; // bit 0 Endpoint number
    volatile uint32_t BCNT : 11; // bit 4 Byte count
    volatile uint32_t DPID : 2; // bit 15 Data PID
    volatile uint32_t PKTSTS : 4; // bit 17 Packet status
    volatile uint32_t FRMNUM : 4; // bit 21 Frame number
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t RXFD : 16; // bit 0 RxFIFO depth
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t TX0FSA : 16; // bit 0 Endpoint 0 transmit RAM start address
    volatile uint32_t TX0FD : 16; // bit 16 Endpoint 0 TxFIFO depth
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t NPTXFSA : 16; // bit 0 Non-periodic transmit RAM start address
    volatile uint32_t NPTXFD : 16; // bit 16 Non-periodic TxFIFO depth
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t NPTXFSAV : 16; // bit 0 Non-periodic TxFIFO space available
    volatile uint32_t NPTQXSAV : 8; // bit 16 Non-periodic transmit request queue space available
    volatile uint32_t NPTXQTOP : 7; // bit 24 Top of the non-periodic transmit request queue
...
typedef union {
  ...
  struct {
    ...
    volatile uint32_t PWRDWN : 1; // bit 16 Power down
    volatile uint32_t RESERVED16 : 1; // bit 17
    volatile uint32_t VBUSASEN : 1; // bit 18 Enable the VBUS sensing device
    volatile uint32_t VBUSBSEN : 1; // bit 19 Enable the VBUS sensing device
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t PRODUCT_ID : 32; // bit 0 Product ID field
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t PTXSA : 16; // bit 0 Host periodic TxFIFO start address
    volatile uint32_t PTXFSIZ : 16; // bit 16 Host periodic TxFIFO depth
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t INEPTXSA : 16; // bit 0 IN endpoint FIFO2 transmit RAM start address
    volatile uint32_t INEPTXFD : 16; // bit 16 IN endpoint TxFIFO depth
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t INEPTXSA : 16; // bit 0 IN endpoint FIFO3 transmit RAM start address
    volatile uint32_t INEPTXFD : 16; // bit 16 IN endpoint TxFIFO depth
  } BITS;
...
typedef union {
  volatile uint32_t REG;
  struct {
    volatile uint32_t INEPTXSA : 16; // bit 0 IN endpoint FIFO4 transmit RAM start address
    volatile uint32_t INEPTXFD : 16; // bit 16 IN endpoint TxFIFO depth
  } BITS;
