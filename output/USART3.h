 ...
 * for the USART3 peripheral of the STM32F103.
 */
...
#define USART3 ((USART3_t *)USART3_BASE)

#define USART3_SRbits (USART3->SR.BITS)
#define USART3_DRbits (USART3->DR.BITS)
#define USART3_BRRbits (USART3->BRR.BITS)
#define USART3_CR1bits (USART3->CR1.BITS)
#define USART3_CR2bits (USART3->CR2.BITS)
#define USART3_CR3bits (USART3->CR3.BITS)
#define USART3_GTPRbits (USART3->GTPR.BITS)
